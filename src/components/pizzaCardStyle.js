...
export const Container = styled.li`
  ...
  box-shadow: rgb(74, 6, 126) 0px 0px 13px 3px;
  -webkit-box-shadow: rgb(74, 6, 126) 0px 0px 13px 3px;
  -moz-box-shadow: rgb(74, 6, 126) 0px 0px 13px 6px;
  :hover {
...
export const RemoveCartButton = styled(RemoveShoppingCartIcon)`
  && {
    width: 2.5rem;
    font-size: 2.5rem;
    color: #e0c529;
